...
class ChessMoveServiceTest {
    ...
    void executeMove() {
        ChessPiece whitePawn = ChessPiece.builder()
                ...
                .availablePositions(Stream.of(ChessPosition.E3, ChessPosition.E4).collect(Collectors.toSet()))
                .build();
        ...
        assertThat(whitePawn).hasOnlyAvailablePositions(ChessPosition.E5);
    }
